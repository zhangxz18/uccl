...
while true; do
    tx1=$(cat /sys/class/infiniband/${NIC}/ports/1/counters/port_xmit_data)
    rx1=$(cat /sys/class/infiniband/${NIC}/ports/1/counters/port_rcv_data)
    sleep 1
    tx2=$(cat /sys/class/infiniband/${NIC}/ports/1/counters/port_xmit_data)
    rx2=$(cat /sys/class/infiniband/${NIC}/ports/1/counters/port_rcv_data)
